...
\newacronym{lqr}{LQR}{Linear Quadratic Controller}
\newacronym{uart}{UART}{Universal Asynchronous Receiver or Transmitter}
\newacronym{lsb}{LSB}{Least Significant Bit}
\newacronym{dma}{DMA}{Direct Memory Access}
\newacronym{vmc}{VMC}{Virtual Model Control}
\newacronym{ivp}{IVP}{Inverted Pendulum}
